...
CUSTOM_VERSION := HorizonDroid-$(CUSTOMVERSION)-$(CUSTOM_MOD_VERSION)-$(CUSTOM_BUILD)-$(CUSTOM_BUILD_DATE)-$(CUSTOM_BUILD_TYPE)
CUSTOM_MOD_VERSION :=$(ANDROID_VERSION)-$(CUSTOMVERSION)
CUSTOM_DISPLAY_VERSION := HorizonDroid-$(CUSTOMVERSION)-$(CUSTOM_BUILD_TYPE)
